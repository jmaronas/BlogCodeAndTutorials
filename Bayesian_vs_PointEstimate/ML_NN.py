...
This script implement a Maximum Likelihood Neural Network on a toy problem: a 4 class problem over 2 dimensional input features. Features are simulated from gaussian distributions.
Set variable visualize=1 to plot the distributions.
...
print("On ML Network getting accuracy of {}".format(float((net.forward(x_test).argmax(1)==t_test).sum())*100./float(t_test.size(0))))
